...
INC=-I${TF_INC}
layer_norm_fused_op: register_ops.cc cuda_kernel_helper.h layer_norm_fused_op.h layer_norm_fused_op.cc layer_norm_fused_grad_op.cc layer_norm_fused_op_gpu.cu.cc
